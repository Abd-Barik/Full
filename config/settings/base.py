...
MIGRATION_MODULES = {"sites": "inspinia.contrib.sites.migrations"}
...
ADMINS = [("""webapplayers""", "support@webapplayers.com")]
...
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "inspinia.users.forms.UserSocialSignupForm"}
