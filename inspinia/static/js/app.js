...
// demo only
const skinPresets = {
    classic: { theme: 'light', topbar: 'light', menu: 'light', sidenav: { user: true } }
};
...
class Plugins {
    ...
    initFlatPicker() {
        document.querySelectorAll("[data-provider]").forEach(item => {
            ...
            const dateConfig = { disableMobile: true };
...
class I18nManager {
    constructor({
        ...
        this.selectedLanguage = sessionStorage.getItem('__INSPINIA_LANG__') || defaultLang;
